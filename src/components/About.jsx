...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-screen bg-gradient-to-b from-white to-emerald-100 dark:from-gray-600 dark:to-gray-900 dark:text-white"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="max-w-[1024px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-right text-6xl max-sm:text-3xl font-bold ">
            <p>I'm a Front End Developer</p>
          </div>
          <div>
            I'm Vladislav Yankov from Bulgaria, 24 years old and im living in Varna, Bulgaria. Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam culpa quod quos eaque, necessitatibus facilis soluta quaerat quo vitae, ex voluptates exercitationem. Alias, ea. Fugiat optio culpa eos fuga aliquid earum placeat tempore, tempora sit quo? Deleniti rem quam modi tempora obcaecati quisquam dolorem, atque esse facere, dolores voluptatibus ex minima ea distinctio!
          </div>
          <Link
              to="projects"
              smooth
