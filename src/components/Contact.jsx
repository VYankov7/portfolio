...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-screen bg-gradient-to-b from-emerald-50 to-white dark:from-gray-900 dark:to-gray-600 p-4 dark:text-white"
    >
        ...
        <div className="flex justify-center items-center">
          <form action="https://getform.io/f/55429dd5-65b2-4a44-85b0-57e2ad9eb828" method="POST" className="flex flex-col w-full md:w-1/2">
            ...
            <input
              ...
              className="my-2 p-2 bg-transparent border-2 rounded-md dark:text-white focus:outline-none"
            />
            <textarea
              name="message"
